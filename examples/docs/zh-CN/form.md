...
<el-form ref="form" :model="form" @submit="onSubmit">
  <el-form-item label="活动名称" tooltip="具体的活动名称">
    <el-input v-model="form.name"></el-input>
  </el-form-item>
  <el-form-item label="活动人数">
    <el-input-number v-model="form.persons" placeholder="请输入活动人数"/>
  </el-form-item>
...
```html
<el-form :model="numberValidateForm" ref="numberValidateForm" label-width="100px" class="demo-ruleForm" @submit="onAutoValidSubmit" :rules="autoValidRules">
  <el-form-item label="年龄" prop="age">
